...
export function buildProposalSheet(spreadsheet, { calculationData, formulaData, rockExcavationTotals, lineDrillTotalFT, rawData }) {
    ...
    if (Array.isArray(calculationData) && calculationData.length > 0) {
      ...
      baseBidTotalRows.push(19) // Demolition Total
      ...
      baseBidTotalRows.push(31) // Soil Excavation Total
      ...
      spreadsheet.setRowHeight(22, currentRow - 1, proposalSheetIndex)
      currentRow++
      ...
      const renderProposalLine = (line) => {
        ...
        if (line.allowance) {
          ...
          spreadsheet.setRowHeight(dynamicHeight, currentRow - 1, proposalSheetIndex)
