  ...
  structure: [
    {
      ...
      subsections: [
        ...
        { name: 'Demo pile caps', items: [] },
        { name: 'Demo pilaster', items: [] },
        { name: 'Demo grade beam', items: [] },
        { name: 'Demo tie beam', items: [] },
        { name: 'Demo strap beam', items: [] },
        { name: 'Demo thickened slab', items: [] },
        { name: 'Demo buttress', items: [] },
        { name: 'Demo pier', items: [] },
        { name: 'Demo corbel', items: [] },
        { name: 'Demo liner wall', items: [] },
        { name: 'Demo barrier wall', items: [] },
        { name: 'Demo stem wall', items: [] },
        { name: 'Demo elevator pit', items: [] },
        { name: 'Demo service elevator pit', items: [] },
        { name: 'Demo detention tank', items: [] },
        { name: 'Demo duplex sewage ejector pit', items: [] },
        { name: 'Demo deep sewage ejector pit', items: [] },
        { name: 'Demo sewage ejector pit', items: [] },
        { name: 'Demo sump pump pit', items: [] },
        { name: 'Demo grease trap pit', items: [] },
        { name: 'Demo house trap pit', items: [] },
        { name: 'Demo mat slab', items: [] },
        { name: 'Demo mud slab', items: [] }
      ]
    },
    {
      section: 'Excavation',
    ...
    },
    {
      ...
      subsections: [
        ...
        { name: 'Tie back anchor', items: [] },
        { name: 'Tie down anchor', items: [] },
