...
export const proposalAPI = {
    ...
    create: async (formData) => {
        const response = await axios.post(`${API_URL}/api/proposals`, formData, {
            headers: {
     ...
     */
    list: async (params = {}) => {
        const response = await axios.get(`${API_URL}/api/proposals`, { params });
        return response.data;
    },
     ...
     */
    getById: async (id) => {
        const response = await axios.get(`${API_URL}/api/proposals/${id}`);
        return response.data;
    },
    ...
    update: async (id, data) => {
        const response = await axios.put(`${API_URL}/api/proposals/${id}`, data);
        return response.data;
    },
     ...
     */
    delete: async (id) => {
        const response = await axios.delete(`${API_URL}/api/proposals/${id}`);
        return response.data;
    },
    /**
    ...
    bulkDelete: async (ids) => {
        const response = await axios.post(`${API_URL}/api/proposals/bulk-delete`, { ids });
        return response.data;
    },
};
