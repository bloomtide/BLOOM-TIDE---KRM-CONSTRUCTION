    ...
    formulaData.forEach((formulaInfo) => {
      ...
      if (section === 'demolition') {
        if (itemType === 'demolition_sum') {
          // Handle sum formulas for demolition subsection (same as Foundation: exclude I when excludeISum for slab-only groups)
          const { firstDataRow, lastDataRow, subsection, excludeISum } = formulaInfo
          try {
            if (!excludeISum) {
